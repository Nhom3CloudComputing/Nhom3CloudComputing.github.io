...
<body>
    ...
    <div class="modal modal_change_pass_success">
            ...
            <div class="auth_form">
                <div class="auth_form_left">
                    ...
                    <div class="signup_success_content">
                        ...
                        <span class='success_title' id='success_title_signup'>Password successfully changed.</span>
                        <div class="signup_success_content_session">
                            <a href="index.php" id="btn_exit_change">Exit</a>
                            <a href="index.php" id="go_to_login">Go to login</a>
                        </div>
                    </div>
                </div>
