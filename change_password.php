...
<body>
    ...
    <div class="modal modal_signup modal_forgot_pass ">
        ...
        <div class="modal__body">
            <div class="auth_form change_pass_form">
                ...
                <div class="auth_form_left forgot_form">
                    <h1 class="title_change_pass_form">Welcome!</h1>
                    <span>Change your password</span>
                    <form action="val_change_pass.php" class="login_form" method = "post">

                        <?php
                            if(isset($_SESSION['error_change'])) {
                                echo "<p class='error_title' id='error_title_change_pass'>{$_SESSION['error_change']}</p>";
                                unset($_SESSION['error_change']); // clear the error message after displaying
                            }
                        ?>
                        <label for="email_change" class="label_input label_email_change" >Email</label>
                        <input type="text" name="email_change_" id="email_change_"><br>

                        <label for="old_password" class="label_input label_old_pass" >Old password</label>
                        <input type="password" name="old_pass" id="old_pass"><br>

                        <label for="new_password" class="label_input label_new_pass">New Password</label>
                        <input type="password" name="new_pass" id="new_pass"><br>

                        <label for="new_password" class="label_input label_confirm">Confirm Password</label>
